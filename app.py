...
class GeeTestIdentifier:
    ...
    def find_puzzle_piece_position(self):
        ...
        if self.debugger:
            ...
            cv2.line(self.background, (top_left[0], center_y), (bottom_right[0], center_y), (0, 0, 255), 2)
            cv2.line(self.background, (center_x, top_left[1]), (center_x, bottom_right[1]), (0, 0, 255), 2)
