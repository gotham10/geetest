...
class GeeTestIdentifier:
    ...
    def find_puzzle_piece_position(self):
        ...
        if self.debugger:
            ...
            cv2.line(self.background, (center_x, center_y), (0, 0), (0, 0, 255), 2)
            cv2.line(self.background, (center_x, center_y), (self.background.shape[1], 0), (0, 0, 255), 2)
            cv2.line(self.background, (center_x, center_y), (0, self.background.shape[0]), (0, 0, 255), 2)
            cv2.line(self.background, (center_x, center_y), (self.background.shape[1], self.background.shape[0]), (0, 0, 255), 2)
